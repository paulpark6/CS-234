...
##
"""
    This module is used for testing python code in CS 231 and  CS 234;
    it is taken from the version designed for CS 116 in 2017.
    ...
    * check.set_file, for testing file output
    ...
    the Python Style guide for CS 231 or CS 234, or
...
def run_test(label, result, expected, tolerance):
    ...
    Do not use run_test in your code for CS 231 or CS 234.
    """
...
def approx(result, expected, tolerance):
    ...
    Do not use approx in your code for CS 231 or CS 234.
    """
...
def compare_files(label, new_files, fname1, fname2, exact):
    ...
    Do not use compare_files in your code for CS 231 or CS 234.
